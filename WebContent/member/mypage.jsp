	        ...
	        <div class="col-md-12">
	        	...
	        	<form method="post" name="f" action="update.jsp">
				  <div class="form-group">
	                <input type="text" class="form-control" id="email" name="email" placeholder="Your Email *" value="<%=dto.getEmail() %>" readonly/>
	              ...
	              <div class="form-group">
	                <input type="password" class="form-control" id="cpwd" name="cpwd"  placeholder="현재 비밀번호" value="" />
	              ...
	              <div class="form-group">
	                <input type="password" class="form-control" id="pwd" name="pwd"  placeholder="신규 비밀번호" value="" />
				...
				<div class="text-right" style="margin-bottom : 20px;">
					...
					<a href="login.jsp" class="btn btn-outline-success">취소</a>
				</div>
	        </div>
        </div>
    </div>
